...
insert into rahmaniadb.`role` (id , name) VALUE (1 , 'admin');
insert into rahmaniadb.`role` (id , name) VALUE (2 , 'student');
insert into rahmaniadb.`user` (id ,active , mobile_number, password,role_id , name ) VALUE(1 ,true , '0567926657' ,'$2a$10$m550MS8fu7jUgpQKZbSzU.I5EPGeKps.8CN4zM8LJxg2ViyJOeIfG', 1 , 'بهاء احمد بيومي');
insert into admin_user(id) VALUE (1);
...
insert into rahmaniadb.`role`(id ,name) value (3 , 'anonymous');
